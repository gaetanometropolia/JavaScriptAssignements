...
if (question === true){
    ...
    if (number<0) {
        document.querySelector("#target").innerHTML= "The sq root of a negative number is not defined";
    }
    else {
        const root = Math.sqrt(number);
        document.querySelector("#target").innerHTML = `The square root of ${number} is ${root}`;
    }
    }
else{
